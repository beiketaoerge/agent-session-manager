...
- **Quick switcher** (`Ctrl+Shift+K`) jumps to any session by type-ahead; the **New Session** folder chooser starts in your last folder; the sidebar is **resizable** and its width is remembered.
